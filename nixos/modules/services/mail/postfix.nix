  ...
  config = mkIf config.services.postfix.enable {
    ...
    systemd.services.postfix =
      { description = "Postfix mail server";
        ...
        preStart = ''
          ${pkgs.coreutils}/bin/mkdir -p /var/lib/postfix/data /var/lib/postfix/queue/{private,pid,public,maildrop}
          ...
          ${pkgs.coreutils}/bin/chmod 700 /var/lib/postfix/queue/{private,public}
          ${pkgs.coreutils}/bin/chmod 770 /var/lib/postfix/queue/maildrop
